...
-- ============================================================================
-- STEP 2: Creare funzioni helper SECURITY DEFINER (bypassano RLS)
-- ============================================================================
...
-- ============================================================================
-- VERIFICA CHE TUTTI GLI UTENTI ABBIANO UN RUOLO
-- ============================================================================

-- Assegna ruolo 'operator' a tutti gli utenti che non ne hanno uno
INSERT INTO user_roles (user_id, role)
SELECT id, 'operator'
FROM auth.users
...
-- 1. Esegui questo script completo nel SQL Editor di Supabase
-- 2. Ricarica la pagina dell'applicazione
-- 3. Prova ad eliminare un ordine - dovrebbe funzionare!
--
-- Per verificare che tutto funzioni, esegui:
--
-- SELECT u.email, ur.role
-- FROM auth.users u
-- LEFT JOIN user_roles ur ON u.id = ur.user_id;
--
-- Tutti gli utenti dovrebbero avere un ruolo assegnato.
