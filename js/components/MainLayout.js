export const MainLayout = () => `
    ...
    <section class="saved-orders-section bg-white rounded-2xl shadow-lg overflow-hidden">
        <!-- Header with gradient -->
        <div
            class="saved-orders-section-header bg-gradient-to-br from-[#FF9900] to-[#FF7700] dark:from-[#FF9900] dark:to-[#FFAC33] p-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center gap-3 text-white">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold">Ordini Salvati</h2>
                        <p class="text-sm text-white/80" id="orders-count">Caricamento...</p>
                    </div>
                </div>

                <div class="flex flex-wrap gap-2">
                    <button id="export-csv-btn"
                        class="px-6 py-3 bg-white/20 backdrop-blur-sm text-white font-semibold rounded-xl border-2 border-white/30 transition-all duration-300 hover:bg-white hover:text-green-600 hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <button id="export-all-orders-btn"
                        class="px-6 py-3 bg-white/20 backdrop-blur-sm text-white font-semibold rounded-xl border-2 border-white/30 transition-all duration-300 hover:bg-white hover:text-brand hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                        </svg>
                        <span class="hidden sm:inline">Esporta Tutti in PDF</span>
                        <span class="sm:hidden">Esporta PDF</span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <!-- Orders Grid -->
        <div class="p-6">
            <div id="saved-orders" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5"></div>
        </div>
    </section>
`;